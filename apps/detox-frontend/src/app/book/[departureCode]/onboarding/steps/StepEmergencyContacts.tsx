          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input value={t.emergencyName} onChange={(e) => onUpdate(i, { emergencyName: e.target.value })} placeholder="Name" className="h-12 pl-11 rounded-xl bg-white border-0 text-sm" />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input value={t.emergencyPhone} onChange={(e) => onUpdate(i, { emergencyPhone: e.target.value })} placeholder="Phone" className="h-12 pl-11 rounded-xl bg-white border-0 text-sm" />
              </div>
            </div>
