      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 pt-24 pb-6">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-3xl">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-semibold uppercase tracking-[0.2em] text-white/70">Get in Touch</span>
            <span className="h-px w-8 bg-white/40" />
          </div>
          ...
          <p className="text-base sm:text-lg text-white/70 leading-relaxed max-w-xl mx-auto">Have a question about a detox, a corporate inquiry, or just want to say hello? We read every message.</p>
        </motion.div>
      </div>
    </div>
  );
