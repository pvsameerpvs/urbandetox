...
const features = [
  ...
  { icon: Users, title: "Small Groups", description: "Usually around ten travellers, never more than a dozen, and the exact number is on every trip page. Big enough to make friends, small enough to stay personal." },
  { icon: Heart, title: "Local Stays", description: "Family-run cottages and homestays, chosen and checked by us. Not luxury, but real, with hosts who care." },
