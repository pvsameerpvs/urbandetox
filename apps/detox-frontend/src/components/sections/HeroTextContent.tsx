  ...
  return (
    <div className="relative flex-1 flex flex-col items-center justify-center px-4 pt-24 sm:pt-28 pb-4">
      ...
      >
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-balance leading-[1.15] text-white">
          {heroText.headline1}
          <span className="block mt-1.5 text-white">{heroText.headline2}</span>
        </h1>
        <p className="mt-4 text-base leading-7 text-white text-balance max-w-lg mx-auto">
