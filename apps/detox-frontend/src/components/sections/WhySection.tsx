      ...
      >
        ...
        <CardContent className="p-4 sm:p-7">
          ...
          <div className="flex items-start justify-between mb-3 sm:mb-4">
            <span className="text-2xl sm:text-4xl font-bold text-brand/10 group-hover:text-brand/20 transition-colors duration-500">
              {num}
            </span>
            <div className="rounded-2xl bg-brand/8 p-2 sm:p-3 group-hover:bg-brand/12 transition-colors duration-500">
              <Icon className="h-5 w-5 sm:h-6 sm:w-6 text-brand" />
            </div>
          </div>

          {/* Title */}
          <h3 className="text-sm sm:text-lg font-bold mb-1.5 sm:mb-2 leading-snug">{title}</h3>

          {/* Description */}
          <p className="line-clamp-4 sm:line-clamp-none text-xs sm:text-sm text-muted-foreground leading-relaxed">
            {description}
          </p>
        </CardContent>
      </Card>
